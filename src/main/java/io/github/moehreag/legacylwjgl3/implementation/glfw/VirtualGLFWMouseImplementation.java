...
public class VirtualGLFWMouseImplementation implements MouseImplementation {
	...
	private static class XCursor {
		...
		private static long fileVersion;
		private static long toCEntryCount;
		private static TableOfContents[] toC;
		private static Chunk[] chunks;

		public XCursor(String magic2, long headerLength2, long version, long ntoc, TableOfContents[] toc2,
				Chunk[] chunks2) {
            this.magic = magic2;
            this.headerLength = headerLength2;
            this.fileVersion = version;
            this.toCEntryCount = ntoc;
            this.toC = toc2;
            this.chunks = chunks2;
		}
		...
		private static class TableOfContents {
			...
			public TableOfContents(long l, long m, long n) {
	            this.type = l;
	            this.subtype = m;
	            this.position = n;
	        }
		...
		private abstract static class Chunk {
			private static long length; // header length
			private static long type; // must match Table of Contents
			private static long subtype;
			private static long version; // Chunk type version
